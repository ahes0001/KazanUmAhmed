...
function Gallery() {
    ...
    let t0;
    if ($[1] !== t.gallery.eyebrow || $[2] !== t.gallery.heading) {
    ...
    let t1;
    if ($[4] !== t.gallery.imageLabels) {
        t1 = galleryImages.map({
            "Gallery[galleryImages.map()]": (image, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
